...
To get to the Microsoft Edge settings pages, select **Settings and more** (![Settings and more icon](./index-images/settings-and-more-icon.png)) > **Settings**.  In some sections, this document provides shortcut links to go directly to specific **Settings** pages.  The shortcut links start with `edge://`, such as `edge://favorites`.  To go to such a shortcut link, paste or type the link into the Microsoft Edge Address bar.  These **Settings** pages are only viewable in Microsoft Edge.
...
For Microsoft Edge on Windows 10 and later, sending Optional diagnostic data is determined by your Windows diagnostic data setting.  The setting is reflected in **Settings and more** (![Settings and more icon](./index-images/settings-and-more-icon.png)) > **Settings** > **Privacy and security**, but is not set through that location.  Instead, change the Windows settings by going to **Start** > **Settings** > **Privacy** > **Diagnostics & feedback**.  On platforms other than Windows, to control the collection of diagnostic data, select **Settings and more** (![Settings and more icon](./index-images/settings-and-more-icon.png)) > **Settings** > **Privacy and security**, and then use the toggle **Help improve Microsoft products by sending optional diagnostic data about how you use the browser, websites you visit, and crash reports**.  The setting is used for all profiles that are associated with the installation of Microsoft Edge on your device.  The setting is not synced across devices.  The setting applies to **InPrivate** browsing and Guest mode.  Information about websites you visit is never sent while browsing **InPrivate** or in **Guest** mode.  If your device is managed by using group policies that are set by your organization, the setting is reflected in **Settings and more** (![Settings and more icon](./index-images/settings-and-more-icon.png)) > **Settings** > **Privacy and security**.
<!-- todo: break up paragraph, add h4 headings in this h2 section -->
