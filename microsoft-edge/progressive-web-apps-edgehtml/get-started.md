...
1.  Test out your PWA!  Build \(`Ctrl`+`Shift`+`B`\) and Run \(`F5`\) your web app to launch Microsoft Edge and open your `localhost` page.  Then complete the following steps.  
    ...
    1.  In the **Application** panel, expand the **Service Workers** control and click on your origin.  In the **Service Worker Overview**, verify your service worker is activated and running.  
