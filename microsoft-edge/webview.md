...
Raised when an HTTP request is made.
...
|            |      |
|------------|------|
|**Interface** | WebResourceRequestedEvent ([Event](https://developer.mozilla.org/en-US/docs/Web/API/Event)) |
|**Synchronous** |Yes |    
|**Bubbles**     |No |   
|**Cancelable**  |No |     
