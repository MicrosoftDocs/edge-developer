...
Like a standard HTML [iframe](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/iframe) element,  you can use WebView to load remote pages over HTTP and local pages (*ms-appx-web:///*) from your app package. However, the WebView can also:
 ...
 - Load pages and resources from your [ApplicationData](https://docs.microsoft.com/uwp/api/Windows.Storage.ApplicationData) (local, roaming, temp) folders (*ms-appdata:///*) and [in-memory streams](https://docs.microsoft.com/microsoft-edge/hosting/webview#buildlocalstreamuri) (*ms-local-stream:///*)
 ...
 - [Capture screenshots of web content](#capturepreviewtoblobasync) making it easy to implement the Windows 10 app [Share](https://docs.microsoft.com/windows/uwp/app-to-app/share-data) contract.
...
Starting with the [Windows 10 October 2018 Update](https://docs.microsoft.com/windows/uwp/whats-new/windows-10-build-17763) (EdgeHTML 18), [service workers are supported in the WebView control](https://docs.microsoft.com/microsoft-edge/dev-guide#service-workers) (in addition to the Microsoft Edge browser and Windows 10 apps with JavaScript).
...
Loads local web content at the specified URI using a [**UriToStreamResolver**](https://docs.microsoft.com/uwp/api/windows.web.iuritostreamresolver.uritostreamasync).
...
*source*
* Type: **String**
* An ms-local-stream URI identifying the local HTML content to load. Create this string using [**buildLocalStreamUri**](https://docs.microsoft.com/uwp/api/windows.web.ui.iwebviewcontrol.buildlocalstreamuri).
