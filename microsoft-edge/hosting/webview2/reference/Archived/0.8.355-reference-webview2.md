...
The Microsoft Edge WebView2 control enables you to host web content in your application using [Microsoft Edge \(Chromium\)](https://www.microsoftedgeinsider.com) as the rendering engine.  See [WebView2](../../../webview2.md) for an overview and [Getting Started](../../getting-started.md) for a quick start.  [IWebView2WebView](0.8.355/IWebView2WebView.md) is a great place to start learning the details of the API.  
