...
> [!NOTE]
> This reference may be altered or unavailable for releases after SDK version 0.9.430. Please refer to [Reference (WebView2)](../../reference-webview2.md) for the latest API reference.
