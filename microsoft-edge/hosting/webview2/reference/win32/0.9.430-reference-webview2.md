...
> [!NOTE]
> This reference may be altered or unavailable for releases after SDK version 0.9.430. Please refer to [WebView2 API Reference](../../webview2-api-reference.md) for the latest API reference.
