...
*   Added [IsZoomControlEnabled](reference/icorewebview2settings.md#get_iszoomcontrolenabled) setting. By default, zoom is enabled within the WebView. Setting IsZoomControlEnabled to False disables zooming.  ([#95](https://github.com/MicrosoftEdge/WebViewFeedback/issues/95)).  
