...
*   Added [IsZoomControlEnabled](reference/icorewebview2settings.md#get_iszoomcontrolenabled) setting. By default, zoom is enabled within the WebView. Setting IsZoomControlEnabled to False disables zooming. Aside from the setting, ZoomView UI is hidden for WebView. ([#95](https://github.com/MicrosoftEdge/WebViewFeedback/issues/95)).  
...
*   Added [WindowClosedRequested](reference/icorewebview2.md#add_windowclosedrequested) event. See [add_WindowClosedRequested](reference/icorewebview2.md#add_windowclosedrequested) for more details. ([#119](https://github.com/MicrosoftEdge/WebViewFeedback/issues/119))
...
*   **Breaking Change:** Modified DevToolsProtocolEventReceived behavior. Now, you can create a [DevToolsProtocolEventReceiver](reference/icorewebview2devtoolsprotocoleventreceiver.md) for a particular DevTools Protocol event and subscribe/unsubscribe to such event using [add_DevToolsProtocolEventReceived](reference/icorewebview2devtoolsprotocoleventreceiver.md#add_windowclosedrequested)/[remove_DevToolsProtocolEventReceived](reference/icorewebview2devtoolsprotocoleventreceiver.md#remove_windowclosedrequested).
*   **Breaking Change:** Changed WebMessageReceivedEventArgs' [get_WebMessageAsString](reference/Archived/0.8.355/iwebview2webmessagereceivedeventargs.md#addwebmessageasstring) property to a [TryGetWebMessageAsString](reference/icorewebview2webmessagereceivedeventargs.md#trygetwebmessageasstring) method.
