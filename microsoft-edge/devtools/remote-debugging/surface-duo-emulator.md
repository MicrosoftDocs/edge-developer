...
*  Open a desktop instance of [Microsoft Edge](https://www.microsoft.com/edge)<!-- todo: unlink -->, and go to `edge://inspect`:
...
1. Switch back to the desktop instance of [Microsoft Edge](https://www.microsoft.com/edge).<!-- todo: unlink -->
...
1. From the list of open tabs running on the emulator, click **inspect** on the tab that has the web content to be debugged.  [DevTools](../landing/index.yml) opens in a new window.
