...
1. In DevTools, on the main toolbar, click the **More Tools** (![More Tools icon](./webaudio-tool-images/more-tools-icon-light-theme.png)) button, and then select **WebAudio**.
