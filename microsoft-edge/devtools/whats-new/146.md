...
These are the latest DevTools features in the Stable release of Microsoft Edge. Microsoft Edge 146 includes the following updates from the Chromium project:<!-- https://developer.chrome.com/blog/new-in-devtools-146 -->
