...
![Horizontal Activity Bar](./143-images/activity-bar.png)
...
1. Select the **Memory** (![Memory icon](./143-images/memory-icon.png)) tool.
...
1. In the **Filter** dropdown list, instead of **All objects**, select **Objects retained by event handlers**:
   ...
   ![Objects retained by event handlers filter](./143-images/objects-retained-by-event-handlers-filter.png)
...
![Save performance trace dialog](./143-images/save-performance-trace-dialog.png)
