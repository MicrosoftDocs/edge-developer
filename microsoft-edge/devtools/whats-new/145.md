...
description: Soft Navigations are now visible in trace view. Line-level profiler timings are now much more precise. Faster trace interaction. And more.  # key words before col 158
author: MSEdgeTeam
...
These are the latest DevTools features in the Stable release of Microsoft Edge. Microsoft Edge 145 includes the following updates from the Chromium project:
