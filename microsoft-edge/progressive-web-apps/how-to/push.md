...
Once you have a VAPID key, you can send push messages to your PWA clients by using [the Web Push Protocol](https://web.dev/push-notifications-web-push-protocol/).<!-- todo: web.dev ok, or developer.mozilla.org? -->
...
* [Push notifications overview](https://web.dev/push-notifications-overview/)<!-- todo: web.dev ok, or developer.mozilla.org? -->
