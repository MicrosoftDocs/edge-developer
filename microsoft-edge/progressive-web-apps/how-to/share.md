...
*  [Integrate with the OS sharing UI with the Web Share API](https://web.dev/web-share/)<!-- todo: web.dev ok, or link to https://developer.mozilla.org? -->
*  [Receiving shared data with the Web Share Target API](https://web.dev/web-share-target/)<!-- todo: web.dev ok, or link to https://developer.mozilla.org? -->
