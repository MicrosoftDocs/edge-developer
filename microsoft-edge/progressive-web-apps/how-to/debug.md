...
To view the total amount of stored data used by your PWA, the available quota, and delete the data, use the **Storage** pane of the **Application** tool.  See [Cear storage](../../devtools/progressive-web-apps/index.md#clear-storage) in _Debug a Progressive Web App (PWA)_.
