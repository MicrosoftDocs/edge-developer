...
1. Click the **Settings** (![Settings icon](./icons/settings-gear-icon-light-theme.png)) button.

**To zoom DevTools by using the Command Menu:**

1. Click the **Customize and control DevTools** (![Customize icon](./icons/customize-devtools-icon-light-theme.png)) menu button, and then select **Run command**.
...
* Icon tools:
   *  **Inspect tool** (![Inspect tool icon](./icons/inspect-tool-icon-light-theme.png)) toggle button.
   *  **Device Emulation** (![Device Emulation icon](./icons/device-emulation-icon-light-theme.png)) button.
...
* Icons:
   *  **More tabs** (![More tabs icon](./icons/more-tabs-icon-light-theme.png)) button.
   *  **More Tools** (![More Tools icon](./icons/more-tools-icon-light-theme.png)) button.
   *  **JavaScript errors counter** (![JavaScript errors counter icon](./icons/javascript-counter-icon-light-theme.png)) button.
   *  **Issues counter** (![Issues counter icon](./icons/issues-counter-icon-light-theme.png)) button.
   *  **Settings** (![Settings icon](./icons/settings-gear-icon-light-theme.png)) button.
   *  **Send Feedback** (![Send Feedback icon](./icons/send-feedback-icon-light-theme.png)) button.
   *  **Customize and control DevTools** (![Customize icon](./icons/customize-devtools-icon-light-theme.png)) menu button.
   *  **Close** DevTools (![Close DevTools icon](./icons/close-devtools-icon-light-theme.png)) button.
...
To display a tool that's open but hidden because the window is too narrow, click the **More tabs** (![More tabs icon](./icons/more-tabs-icon-light-theme.png)) button.


<!-- ------------------------------ -->
#### More Tools button

To add a tool to the toolbar, click the **More Tools** (![More Tools icon](./icons/more-tools-icon-light-theme.png)) button.


<!-- ------------------------------ -->
#### JavaScript errors counter

The **JavaScript errors counter** (![JavaScript errors counter icon](./icons/javascript-counter-icon-light-theme.png)) button displays the following:
...
The **Issues counter** (![Issues counter icon](./icons/issues-counter-icon-light-theme.png)) button shows the number of HTML or CSS issues that are automatically found on the current webpage.
...
To open the DevTools **Settings** webpage, click the **Settings** (![Settings icon](./icons/settings-gear-icon-light-theme.png)) button.  The **Settings** page contains the following sub-pages:
...
To open the **Send Feedback** dialog, click the **Send Feedback** (![Send Feedback icon](./icons/send-feedback-icon-light-theme.png)) button.  The **Send Feedback** dialog opens.  Enter information to describe what happened and automatically includes a screenshot.  Use **Send Feedback** to connect with DevTools team to report problems, issues, or suggest ideas.
...
The **Customize and control DevTools** (![Customize and control DevTools](./icons/customize-and-control-devtools-icon-light-mode.png)) button opens a dropdown menu that enables you to define where to dock DevTools, search, open different tools, and more.


<!-- ------------------------------ -->
#### Close DevTools button

Click the **Close** DevTools (![Close DevTools icon](./icons/close-devtools-icon-light-theme.png)) button in the upper right corner of DevTools to close DevTools and use the entire window to display the current webpage.
...
*  In the upper right of DevTools, on the main toolbar, click the **Customize and control DevTools** (![Customize and control DevTools](./icons/customize-and-control-devtools-icon-light-mode.png)) button, hover over the **More tools** command, and then select a tool.
...
*  Click the **Customize and control DevTools** (![Customize and control DevTools](./icons/customize-and-control-devtools-icon-light-mode.png)) button, and then select **Run command**.
...
You can customize DevTools to meet your needs for the way you work.  To change settings, click the **Settings** (![Settings icon](./icons/settings-gear-icon-light-theme.png)) button, or press **F1**.
...
click the **Inspect tool** (![Inspect tool icon](icons/inspect-tool-icon-light-theme.png)) button.
click the **Device Emulation** (![Device Emulation icon](icons/device-emulation-icon-light-theme.png)) button.
click the **More tabs** (![More tabs icon](icons/more-tabs-icon-light-theme.png)) button.
click the **More Tools** (![More Tools icon](icons/more-tools-icon-light-theme.png)) button.
click the **JavaScript errors counter** (![JavaScript errors counter icon](icons/javascript-counter-icon-light-theme.png)) button.
click the **Issues counter** (![Issues counter icon](icons/issues-counter-icon-light-theme.png)) button.
click the **Settings** (![Settings icon](icons/settings-gear-icon-light-theme.png)) button.
select **Settings and more** (![The 'Settings and more' icon](icons/edge-settings-and-more-icon.png))
click the **Send Feedback** (![Send Feedback icon](icons/send-feedback-icon-light-theme.png)) button.
click the **Customize and control DevTools** (![Customize icon](icons/customize-devtools-icon-light-theme.png)) menu button.
click the **Close** DevTools (![Close DevTools icon](icons/close-devtools-icon-light-theme.png)) button.
-->
