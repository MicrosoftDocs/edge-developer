...
If you press `Shift`+`Tab` or move your mouse cursor over the HTML result, DevTools highlights the header for you:

:::image type="content" source="../media/console-dom-highlight-element.msft.png" alt-text="DevTools highlights the section you choose in the Console." lightbox="../media/console-dom-highlight-element.msft.png":::
...
:::image type="content" source="../media/console-dom-add-border.msft.png" alt-text="To add a border to an element, use the Console." lightbox="../media/console-dom-add-border.msft.png":::
...
To get a direct reference to the element to manipulate:

1.  Use the **Inspect** tool to select the element.
...
To list all of the event listener assigned to the first form in the webpage:
...
To log any key action on the currently chosen element, focus on the search form in the header and press some keys.
