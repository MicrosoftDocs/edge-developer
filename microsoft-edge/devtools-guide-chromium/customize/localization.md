...
If you want to revert DevTools to English, navigate to [DevTools Settings][DevtoolschromiumCustomizeIndexSettings] or select `F1` > **Preferences** and deselect the **Match browser language** checkbox.  
