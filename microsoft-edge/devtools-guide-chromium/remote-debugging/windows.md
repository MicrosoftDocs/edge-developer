...
The file explorer does not launch from the DevTools in the **Sources** tool or in the **Security** panel when remote debugging.  The team plans to fix these tools in a future update of Microsoft Edge.  
