...
:::image type="complex" source="../media/font-editor-setting-to-16px.msft.png" alt-text="Changing the font size to 16 pixels" lightbox="../media/font-editor-setting-to-16px.msft.png":::

Opening the unit dropdown to convert to `em`:

:::image type="complex" source="../media/font-editor-converted-to-em.msft.png" alt-text="Opening the unit dropdown to convert to em" lightbox="../media/font-editor-converted-to-em.msft.png":::
...
:::image type="complex" source="../media/font-editor-preset-font-sizes.msft.png" alt-text="Opening the preset keyword interface" lightbox="../media/font-editor-preset-font-sizes.msft.png":::
