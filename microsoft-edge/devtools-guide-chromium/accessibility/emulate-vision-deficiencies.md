...
1. Go to **More tools** > **Rendering** to open the **Rendering** panel in the drawer.
   ...
   > ![Opening the Rendering panel from the More tools menu](../media/getting-to-the-rendering-tools.png)

1. Scroll down to the **Emulate vision deficiencies** section, click the **No emulation** dropdown list, and then select an option.

   > [!div class="mx-imgBorder"]
   > ![The Emulate vision deficiencies section in the Rendering panel](../media/accessibility-emulate-vision-menu-options.png)

1. The browser window simulates the selected vision deficiency on the current page.

   > [!div class="mx-imgBorder"]
   > ![The browser window, with modified colors in the web page to simulate the selected color vision deficiency](../media/accessibility-blurred-vision-emulation.png)
...
1. Type **emulate**, select the type of vision deficiency you want to simulate, and then press **Enter**.
   ...
   > [!div class="mx-imgBorder"]
   > ![The command menu showing the different types of vision deficiencies](../media/accessibility-emulation-command-menu-results.png)
