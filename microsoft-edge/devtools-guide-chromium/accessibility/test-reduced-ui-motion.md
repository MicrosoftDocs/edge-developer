...
1. In the **Emulate CSS media feature prefers-reduced-motion** dropdown list, select **prefers-reduced-motion: reduced**.
   ...
   ![Simulating reduced motion and the CSS that makes sure that smooth scrolling only happens when the user wants it](./test-reduced-ui-motion-images/a11y-testing-simulating-reduced-motion.png)
