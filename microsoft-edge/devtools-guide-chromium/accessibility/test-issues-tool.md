...
*  [Find and fix problems by using the Issues tool][DevToolsIssuesTool]
...
<!-- links -->
[DevToolsIssuesTool]: ../issues/index.md "Find and fix problems by using the Issues tool | Microsoft Docs"
