...
:::image type="content" source="../media/ie-mode-badge.msft.png" alt-text="The IE mode indicator icon in the address bar." lightbox="../media/ie-mode-badge.msft.png":::
...
:::image type="content" source="../media/ie-mode-badge-doc-mode.msft.png" alt-text="View document mode using the IE mode indicator icon." lightbox="../media/ie-mode-badge-doc-mode.msft.png":::
...
*  **Inspect Element** is not visible on the right-click menu.

*  Right-clicking and then selecting **View Source** launches Notepad.

*  Pressing `F12` or `Ctrl`+`Shift`+`I` opens a blank instance of the Microsoft Edge DevTools and displays the following message: **Developer Tools are not available in Internet Explorer mode.  To debug the page, open it in Internet Explorer 11.**

:::image type="content" source="../media/ie-mode-devtools.msft.png" alt-text="DevTools launched in IE mode." lightbox="../media/ie-mode-devtools.msft.png":::
