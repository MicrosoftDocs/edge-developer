...
1. In DevTools, in the upper right, click **Settings** (![Settings button](../icons/settings-button-icon.png)).
...
1. When the performance profile appears, click **Save profile** (![Save profile button](../icons/export-icon.png)):
...
1. Right-click (or hold the **Ctrl** key and click) the **Save profile** (![Save profile button](../icons/export-icon.png)) in the **Performance** tool or the **Save** button in the **Memory** tool.
...
1. Click **Load profile** (![Load profile button](../icons/import-icon.png)):
