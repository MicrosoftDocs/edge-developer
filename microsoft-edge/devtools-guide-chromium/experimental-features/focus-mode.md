...
![The horizontal Activity, with tool names and icons](./focus-mode-images/undocked.png)
...
*  **Inspect** mode (![Inspect tool icon](../icons/inspect-tool-icon-light-theme.png)) toggle button.

*  **Device Emulation** mode (![Device Emulation icon](../icons/device-emulation-icon-light-theme.png)) button.
