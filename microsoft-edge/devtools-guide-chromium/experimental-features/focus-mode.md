...
You can hide or expand **Quick View** by clicking **Collapse Quick View** / **Expand Quick View** or pressing the **Escape** key. (![Quick view chevron toggle icon](./focus-mode-images/chevron.png)).
