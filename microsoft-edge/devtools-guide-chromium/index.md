...
:::image type="complex" source="./media/devtools.png" alt-text="Microsoft Edge (Chromium) DevTools":::
...
:::image type="complex" source="./media/devtools-core-tools.png" alt-text="Microsoft Edge (Chromium) DevTools core tools":::
...
:::image type="complex" source="./media/allow-extensions-from-stores.png" alt-text="Chrome Web Store in Microsoft Edge":::
...
:::image type="complex" source="./media/install-extension-from-chrome-store.png" alt-text="Adding extension from Chrome Web Store to Microsoft Edge":::
