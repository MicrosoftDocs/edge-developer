...
*  Right-click any item on a webpage and then click **Inspect**.  DevTools opens, with the **Elements** tool selected.

*  Press `F12`.  DevTools opens, with the **Welcome** tool or the last-used tool selected.

*  Press `Ctrl`+`Shift`+`I` (on Windows/Linux) or `Command`+`Option`+`I` (on macOS).  DevTools opens, with the **Welcome** tool or the last-used tool selected.
...
<!-- add icon -->
The **Open Console to view # errors, # warnings** (**JavaScript Errors**) button displays a red circle with an `X`, followed by the number of JavaScript errors.

To open the [Console](console/index.md) and learn about the error, click the **JavaScript Errors** button.


#### Issues icon button

Next to the Tools tab group, an **Issues** icon button appears when there are JavaScript _issues_ on the current webpage.

<!-- add icon -->
The **Open Issues to view # issues** (**Issues**) button is a blue message icon followed by the number of issues.

To open the [Issues](./issues/index.md) tool, click the **Issues** button.


#### Settings icon button

<!-- add icon -->
The **Settings** icon button displays a gear icon.  To open DevTools **Settings** webpage, select the **Settings** button.  The **Settings** webpage displays a menu to change **Preferences**, turn on **Experiments**, and much more.


#### Send Feedback icon button
...
#### Customize and control DevTools** button

<!-- add icon -->
The **Customize and control DevTools** (`...`) button opens a dropdown menu.  It allows you to define where to dock DevTools, search, open different tools, and more.
