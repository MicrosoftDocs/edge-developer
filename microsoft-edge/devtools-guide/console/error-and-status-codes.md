...
**Note** For websites in a user's trusted security zone, Microsoft Edge doesn't check the MIME type of a style sheet.
...
Code | Message | Description | Suggested fix
:------------ | :------------- | :------------- | :-------------
| HTML1112 | "Codepage restart from [encoding] to  [encoding]" | A codepage was specified that differs from the server's. | Use the same codepage as the server to avoid this error. |
