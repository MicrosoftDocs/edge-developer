...
<!-- checkbox has a "(?)" link
https://docs.microsoft.com/microsoft-edge/devtools-guide/experimental-features/#sync-css-changes-in-the-styles-pane
...
<!-- checkbox has a "(?)" link
https://learn.microsoft.com/en-us/microsoft-edge/devtools-guide/experimental-features/#group-sources-into-authored-and-deployed-trees
pointing to this anchor wording -->
...
See also:
* [Overview and timelines for migrating to Manifest V3](../../extensions/developer-guide/manifest-v3.md) - service workers instead of background pages, for Microsoft Edge extensions.
...
<!-- checkbox has a "(?)" link
https://docs.microsoft.com/microsoft-edge/devtools-guide/experimental-features/#log-devtools-uncaught-exceptions-to-console
pointing to this anchor wording -->
...
## Enable webhint
<!-- checkbox has a "(?)" link
https://docs.microsoft.com/microsoft-edge/devtools-guide/experimental-features/#enable-webhint
pointing to this anchor wording -->
...
<!-- checkbox has a "(?)" link
https://docs.microsoft.com/microsoft-edge/devtools-guide/experimental-features/#show-issues-in-elements
pointing to this anchor wording -->
...
<!-- checkbox has a "(?)" link
https://docs.microsoft.com/microsoft-edge/devtools-guide/experimental-features/#open-source-files-in-visual-studio-code
pointing to this anchor wording -->
...
internal only
checkbox has a "(?)" link
https://docs.microsoft.com/microsoft-edge/devtools-guide/experimental-features/#device-performance-profiles
pointing to this anchor wording
