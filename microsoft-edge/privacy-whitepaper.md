...
To turn off crash data collection on Windows 10, go to **Diagnostics & feedback** in Windows Diagnostics & feedback settings.  For versions of Microsoft Edge on all other platforms go to **edge://settings/privacy** and turn off **Improve Microsoft products by sending crash reports and data about how you use the browser**.  This data collection can also be turned off for enterprises through [group policies managed by your organization](https://review.docs.microsoft.com/DeployEdge/microsoft-edge-privacy-policy).  
