...
Users want to see dates, times, numbers, and other formatting printed according to their preferences. For example, the US geographic region translates **7/2/2022** into **Jul. 2nd, 2022**.  Another geographic region could translate that same date into **Feb. 7, 2022** because they read the month and day inversely.
