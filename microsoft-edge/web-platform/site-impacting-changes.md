...
| Disable and remove FTP | Edge v88  | Edge v87 | In v87, FTP support will be disabled by default. In v88, FTP support will be removed. This change is happening in the Chromium project, on which Microsoft Edge is based. For more information, please review the [Chrome Platform Status Entry][[ChromePlatformStatus6246151319715840].  | 
##### Release comments  
