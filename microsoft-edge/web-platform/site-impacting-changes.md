...
| Block WebSQL in 3rd-party contexts | Edge v97  |  | Use of the legacy WebSQL feature will be blocked from 3rd-party frames. An Enterprise policy [WebSQLInThirdPartyContextEnabled](/deployedge/microsoft-edge-policies#websqlinthirdpartycontextenabled) will be available as an opt-out until Edge v101. This change is happening in the Chromium project, on which Microsoft Edge is based. For more information, navigate to the [Chrome Platform Status entry](https://chromestatus.com/feature/5684870116278272). |
