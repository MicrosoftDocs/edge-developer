...
* [Picking colors of any pixel on the screen with the EyeDropper API](https://web.dev/eyedropper/)<!-- todo: web.dev ok - keep, or only have the https://developer.mozilla.org link above? --> at web.dev.
