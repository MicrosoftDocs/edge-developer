...
* [Manifest - content scripts](https://developer.chrome.com/docs/extensions/reference/manifest/content-scripts)<!-- todo: developer.chrome.com ok? -->
* [chrome.scripting](https://developer.chrome.com/docs/extensions/reference/api/scripting)<!-- todo: developer.chrome.com ok? -->
* [chrome.storage](https://developer.chrome.com/docs/extensions/reference/api/storage)<!-- todo: developer.chrome.com ok? -->
