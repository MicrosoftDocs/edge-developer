...
* [Manifest - content scripts](https://developer.chrome.com/docs/extensions/reference/manifest/content-scripts)<!-- Ok to keep this Chrome link. The ref docs for extensions in Chromium is there. -->
* [chrome.scripting](https://developer.chrome.com/docs/extensions/reference/api/scripting)<!-- Ok to keep this Chrome link. The ref docs for extensions in Chromium is there. -->
* [chrome.storage](https://developer.chrome.com/docs/extensions/reference/api/storage)<!-- Ok to keep this Chrome link. The ref docs for extensions in Chromium is there. -->
