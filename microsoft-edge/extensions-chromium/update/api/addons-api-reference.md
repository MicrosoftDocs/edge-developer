...
| 500 Internal Server Error | The request wasn't completed. | The server met an unexpected condition. |
 ...
 An example script that you can utilize to check the publication status and publish their extension. You should fill in the values for ClientID, ClientSecret, ProductID, and FilePATH.
