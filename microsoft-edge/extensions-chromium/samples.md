...
|:---|:---|:---|:---|
| Learn to build a Microsoft Edge extension that extends DevTools. | Used for [Create an extension that customizes the DevTools UI](/microsoft-edge/extensions-chromium/developer-guide/devtools-extension). | [/devtools-extension/](https://github.com/MicrosoftEdge/Demos/tree/main/devtools-extension) | n/a |
