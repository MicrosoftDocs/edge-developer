...
*  Verify that the content of the YouTube video follows the [Microsoft Edge Add-ons store developer policies](../store-policies/developer-policies.md).
