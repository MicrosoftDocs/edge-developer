...
| Small promotional tile (optional) | This image is used to display your extension alongside other extensions in the store listing. The store listing of your extension is displayed on this tile. The size of the image should be 440 x 280 pixels. |
...
| Large promotional tile (optional) | Large promotion tiles will be used in the store to feature extensions more prominently in Microsoft Edge add-ons website. These images, if submitted, will be visible to the users soon. The size of these PNG files must be 1400 x 560 pixels.  |
