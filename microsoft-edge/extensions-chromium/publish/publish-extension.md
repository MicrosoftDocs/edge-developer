...
1. To upload your package, drag and drop the zip file to the **Upload** section of the webpage. Or you can select **Browse your files** to open a dialog box to select the package.
