...
| Search terms (optional) | Search terms are single words or phrases that help users discover your extension when searching in the Microsoft Edge Add-ons Catalog. These search terms aren't displayed to users. | 
