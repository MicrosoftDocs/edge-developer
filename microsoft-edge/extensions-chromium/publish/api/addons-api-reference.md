...
For an overview, see [Using the Update REST API for Microsoft Edge Add-ons](./using-addons-api.md).
...
See also:
* [Uploading a package to update an existing submission](./using-addons-api.md#uploading-a-package-to-update-an-existing-submission) in _Using the Update REST API for Microsoft Edge Add-ons_.
...
See also:
* [Checking the status of a package upload](./using-addons-api.md#checking-the-status-of-a-package-upload) in _Using the Update REST API for Microsoft Edge Add-ons_.
...
See also:
* [Publishing the submission](./using-addons-api.md#publishing-the-submission) in _Using the Update REST API for Microsoft Edge Add-ons_.
...
See also:
* [Checking the publishing status](using-addons-api.md#checking-the-publishing-status) in _Using the Update REST API for Microsoft Edge Add-ons_.
...
* [Using the Update REST API for Microsoft Edge Add-ons](./using-addons-api.md)
