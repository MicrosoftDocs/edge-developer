...
The examples below use the domain `https://addons.edge.microsoft.com/api`, which is a placeholder and could be replaced once the API is available in production.
