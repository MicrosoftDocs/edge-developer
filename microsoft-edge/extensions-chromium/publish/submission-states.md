...
| 5 |  In the store.  Update in review |  Your extension is published to the Microsoft Store and you have submitted an update that is under review by Microsoft.  |  
...
| 8 |  Unpublished from store |  You unpublished your extension from the Microsoft Store in Partner Center.  In Partner Center, you chose **unpublish** on the extension submission page.  After unpublishing your extension, it is no longer available in the Microsoft Store for new users to download, but existing users may continue to use their copies of your extension.  |  
...
| 10 |  Blocked |  If your extension is found to be malicious and compromises the security and privacy of users, Microsoft has the right to block your extension from the Microsoft Store, and the state changes to this state.  If your extension is blocked, it is removed from the Microsoft Store and from all user devices.  |  
