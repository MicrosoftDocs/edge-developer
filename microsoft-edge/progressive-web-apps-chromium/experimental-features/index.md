...
<!-- per SME, keep this section heading in this exp-feat article, with a link to the new location, serving as a manual redirect -->

<!-- When this feature is promoted from Experimental to Stable, this section will be moved to the article [Use the Web App Manifest to integrate your Progressive Web App into the Operating System](../webappmanifests.md).   -->
...
<!-- todo: in these 10 lines, work with SME to remove & resolve the word "it" by specific words -->
