...
Windows knows<!--if it knows, why does it ask?--> that your app is registered to handle this URL, and asks you to choose which app you want to use. Select the **DevTools Tips** app. If you want to avoid seeing this dialog every time, select **Remember my choice**.
