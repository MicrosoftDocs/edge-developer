...
See also:
* [Handle specific protocol schemes](./web-app-manifests.md#handle-specific-protocol-schemes) in _Use a web app manifest to integrate a Progressive Web App into the operating system_.
