...
### [Build a simple extension](extensions-chromium/getting-started/part2-running-dev-time.md)
### [Build a simple extension](extensions-chromium/getting-started/part3-content-scripts.md)
### [Build a simple extension](extensions-chromium/getting-started/part4-add-options-page.md)
### [Build a simple extension](extensions-chromium/getting-started/part5-background-script.md)
### [Build a simple extension](extensions-chromium/getting-started/part6-dynamic-content-insertion.md)
