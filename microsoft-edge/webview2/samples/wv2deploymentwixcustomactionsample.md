...
1. In **User Account Control**, click the **Yes** button.  VSIX Installer for WiX Visual Studio extension opens:
   ...
   <!-- ![VSIX Installer for WiX Visual Studio 2022 extension](./wv2deploymentwixcustomactionsample-images/vsix-installer-wix-vs-2022-ext.png) -->
...
1. If a **VSIX waiting for processes to shut down** dialog opens, close Visual Studio.  The VSIX Installer proceeds.
   ...
   <!-- ![VSIX Installer - Install Complete - WiX Toolset Visual Studio 2022 Extension](./wv2deploymentwixcustomactionsample-images/vsix-installer-wix-vs-2022-ext-complete.png) -->
