...
* `CoreWebView2` Class:
    * [CoreWebView2.GetDeferral Property](/microsoft-edge/webview2/reference/winrt/microsoft_web_webview2_core/corewebview2?view=webview2-winrt-1.0.2849.39&preserve-view=true#getdeferral)
...
* Fix download dialog focus issue when tab/shift+tab into Webview2 

<!-- ---------- -->
###### SDK-only

* CoreWebView2.AddWebResourceRequestedFilter without CoreWebView2WebResourceRequestSourceKinds parameter is now deprecated. For more information, please see https://go.microsoft.com/fwlink/?linkid=2286319. 
...
* Added a new `RestartRequested` event. This event is raised whenever WebView2 needs to restart to apply updates or configuration changes. App developers can use this API to detect when WebView2 needs to restart and take appropriate actions. The `Priority` property of the RestartRequested event arguments indicates the priority of the restart request, which can either be `HIGH` or `NORMAL`. 

    - `HIGH` priority indicates that developers should prompt users to restart as soon as possible.
    - `NORMAL` priority indicates that developers should remind users to restart, on a best-effort basis.
...
* [CoreWebView2RestartRequestedPriority Class](/dotnet/api/microsoft.web.webview2.core.corewebview2restartrequestedpriority?view=webview2-dotnet-1.0.2895-prerelease&preserve-view=true)
...
* [ICoreWebView2ScreenCaptureStartingEventArgs](/microsoft-edge/webview2/reference/win32/icorewebview2screencapturestartingeventargs?view=webview2-1.0.2895-prerelease&preserve-view=true)
  ...
  * [ICoreWebView2ScreenCaptureStartingEventArgs::get_OriginalSourceFrameInfo](/microsoft-edge/webview2/reference/win32/icorewebview2screencapturestartingeventargs?view=webview2-1.0.2895-prerelease&preserve-
view=true#get_originalsourceframeinfo)
...
* `CoreWebView2` Class:
    * [CoreWebView2.GetDeferral Property](/microsoft-edge/webview2/reference/winrt/microsoft_web_webview2_core/corewebview2?view=webview2-winrt-1.0.2895-prerelease&preserve-view=true#getdeferral)
...
* Fix Arm64 incompatibility with WindowsAppSdk 1.6
