---
title: Preview Runtime 152.A.BBBB.CC (Aug. 3, 2026)
description: Release notes for Microsoft Edge WebView2 Preview Runtime 152.A.BBBB.CC.
author: MSEdgeTeam
...
ms.date: 08/03/2026
---
<!-- todo when this Runtime becomes stable: below, remove "Preview" and update version number and date. -->
# Preview Runtime 152.A.BBBB.CC (Aug. 3, 2026)

<!-- todo when this Runtime becomes stable: below, remove "Preview" and update version number and date. -->
Release notes for Microsoft Edge WebView2 Preview Runtime 152.A.BBBB.CC, release date: Aug. 3, 2026.

<!-- todo when this Runtime becomes stable: remove paragraph below. -->
