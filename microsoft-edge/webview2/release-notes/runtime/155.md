---
title: Preview Runtime 155.0.4283.13 (Sep. 24, 2026)
description: Release notes for Microsoft Edge WebView2 Preview Runtime 155.0.4283.13.
author: MSEdgeTeam
...
ms.date: 09/24/2026
---
# Preview Runtime 155.0.4283.13 (Sep. 24, 2026)
...
Release notes for Microsoft Edge WebView2 Preview Runtime, release date: Sep. 24, 2026.
...
In addition to the following WebView2 Runtime improvements, you can also use the new web platform features from Microsoft Edge nnn; see [Microsoft Edge 155 web platform release notes (Oct. 8, 2026)](../../../web-platform/release-notes/155.md).


<!-- ====================================================================== -->
#### Bug fixes

* Fixed incorrect viewport in minimal mode.
* Fixed JAWS support in minimal window.


<!-- ====================================================================== -->
## See also

* [SDK 1.0.4283-prerelease, for Runtime 155 (Sep. 24, 2026)](../sdk/1-0-4283-prerelease.md)
...
* [Microsoft Edge 155 web platform release notes (Oct. 8, 2026)](../../../web-platform/release-notes/155.md)
