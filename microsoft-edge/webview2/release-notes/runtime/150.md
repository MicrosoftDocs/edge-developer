---
title: Runtime 150.0.4078.44 (Jul. 7, 2026)
description: Release notes for Microsoft Edge WebView2 Runtime 150.0.4078.44.
author: MSEdgeTeam
...
In addition to the following WebView2 Runtime improvements, you can also use the new web platform features from Microsoft Edge 150; see [Microsoft Edge 150 web platform release notes (Jul. 2, 2026)](../../../web-platform/release-notes/150.md).
...
* [SDK 1.0.4078.44, for Runtime 150 (Jul. 7, 2026)](../sdk/1-0-4078-44.md)
* [SDK 1.0.4071-prerelease, for Runtime 150 (Jun. 11, 2026)](../sdk/1-0-4071-prerelease.md)
* [Release notes for WebView2](../index.md)
   * [Release notes for the WebView2 Runtime](./index.md)
   * [Release notes for WebView2 SDKs](../sdk/index.md)
* [Microsoft Edge 150 web platform release notes (Jul. 2, 2026)](../../../web-platform/release-notes/150.md)
