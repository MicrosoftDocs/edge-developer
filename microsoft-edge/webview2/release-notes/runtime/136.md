...
Release notes for Microsoft Edge WebView2 Runtime, release date: May 5, 2025.

In addition to the following WebView2 Runtime improvements, you can also use the new web platform features from Microsoft Edge 136; see [Microsoft Edge 136 web platform release notes (May 2025](../../../web-platform/release-notes/136.md).
...
* [Microsoft Edge 136 web platform release notes (May 2025](../../../web-platform/release-notes/136.md)
