---
title: Runtime 151.0.4129.50 (Aug. 3, 2026)
description: Release notes for Microsoft Edge WebView2 Runtime 151.0.4129.50.
author: MSEdgeTeam
...
ms.date: 08/03/2026
---
# Runtime 151.0.4129.50 (Aug. 3, 2026)

Release notes for Microsoft Edge WebView2 Runtime, release date: Aug. 3, 2026.

In addition to the following WebView2 Runtime improvements, you can also use the new web platform features from Microsoft Edge 151; see [Microsoft Edge 151 web platform release notes (Jul. 30, 2026)](../../../web-platform/release-notes/151.md).
...
* [SDK 1.0.4129.50, for Runtime 151 (Aug. 3, 2026)](../sdk/1-0-4129-50.md)
* [SDK 1.0.4126-prerelease, for Runtime 151 (Jul. 7, 2026)](../sdk/1-0-4126-prerelease.md)
* [Release notes for WebView2](../index.md)
   * [Release notes for the WebView2 Runtime](./index.md)
   * [Release notes for WebView2 SDKs](../sdk/index.md)
* [Microsoft Edge 151 web platform release notes (Jul. 30, 2026)](../../../web-platform/release-notes/151.md)
