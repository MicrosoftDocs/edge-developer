---
title: Release SDK 1.0.2210.55, for Runtime 120 (Dec. 11, 2023)
description: Release notes for Microsoft Edge WebView2, for Release SDK 1.0.2210.55.
author: MSEdgeTeam
...
For full API compatibility, this Release version of the WebView2 SDK requires WebView2 [Runtime 120.0.2210.55 (Dec. 11, 2023)](../runtime/120.md) or later.
...
* [Promotions to Phase 3 (Stable in Release)](#promotions-to-phase-3-stable-in-release)
   ...
   * [Managing profile deletion](#managing-profile-deletion)
* [Bug fixes](#bug-fixes)
* [See also](#see-also)
...
Previous phase: [Support for browser extensions in WebView2](./1-0-2194-prerelease.md#support-for-browser-extensions-in-webview2) in _Prerelease SDK 1.0.2194-prerelease, for Runtime 120 (Nov. 6, 2023)_.
...
Previous phase: [Frame Process Info API](./1-0-2357-prerelease.md#frame-process-info-api) in _Prerelease SDK 1.0.2357-prerelease, for Runtime 122 (Jan. 30, 2024)_.
...
Previous phase: [`IsBrowserAcceleratorKeyEnabled` property](./1-0-2357-prerelease.md#isbrowseracceleratorkeyenabled-property) in _Prerelease SDK 1.0.2357-prerelease, for Runtime 122 (Jan. 30, 2024)_.
