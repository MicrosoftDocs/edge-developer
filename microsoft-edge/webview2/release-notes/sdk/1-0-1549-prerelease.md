---
title: Prerelease SDK 1.0.1549-prerelease, for Runtime 110 (Dec. 12, 2022)
description: Release notes for Microsoft Edge WebView2, for Prerelease SDK 1.0.1549-prerelease.
author: MSEdgeTeam
...
For full API compatibility, this Prerelease version of the WebView2 SDK requires the WebView2 Runtime that ships with Microsoft Edge version 110.0.1549.0 or later; see [Runtime 110.0.1587.40 (Feb. 15, 2023)](../runtime/110.md).

**Detailed contents:**
* [Experimental APIs (Phase 1: Experimental in Prerelease)](#experimental-apis-phase-1-experimental-in-prerelease)
   * [Locale Region API](#locale-region-api)
