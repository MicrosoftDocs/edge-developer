...
description: Release notes for Microsoft Edge WebView2, for Release SDK 1.0.2849.39.
author: MSEdgeTeam
...
Release notes for Microsoft Edge WebView2 SDK, release date: Oct. 21, 2024.

[NuGet package for WebView2 SDK 1.0.2849.39](https://www.nuget.org/packages/Microsoft.Web.WebView2/1.0.2849.39)

For full API compatibility, this Release version of the WebView2 SDK requires WebView2 [Runtime 130.0.2849.39 (Oct. 21, 2024)](../runtime/130.md) or later.
...
Previous phase: [Configure the security warning when saving a file (`SaveFileSecurityCheckStarting` event)](./1-0-2895-prerelease.md#configure-the-security-warning-when-saving-a-file-savefilesecuritycheckstarting-event) in _Prerelease SDK 1.0.2895-prerelease, for Runtime 131 (Oct. 21, 2024)_.
