...
Release notes for Microsoft Edge WebView2 SDK, release date: Feb. 6, 2022.

[NuGet package for WebView2 SDK 1.0.1108.44](https://www.nuget.org/packages/Microsoft.Web.WebView2/1.0.1108.44)

For full API compatibility, this Release version of the WebView2 SDK requires WebView2 [Runtime 98.0.1108.44 (Feb. 6, 2022)](../runtime/98.md) or later.
...
* [Runtime 98.0.1108.44 (Feb. 6, 2022)](../runtime/98.md)
