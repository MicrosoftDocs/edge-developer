---
title: Release SDK 1.0.1722.45, for Runtime 112 (Apr. 13, 2023)
description: Release notes for Microsoft Edge WebView2, for Release SDK 1.0.1722.45.
author: MSEdgeTeam
...
Release notes for Microsoft Edge WebView2 SDK, release date: Apr. 13, 2023.

[NuGet package for WebView2 SDK 1.0.1722.45](https://www.nuget.org/packages/Microsoft.Web.WebView2/1.0.1722.45)

For full API compatibility, this Release version of the WebView2 SDK requires WebView2 [Runtime 112.0.1722.45 (Apr. 13, 2023)](../runtime/112.md) or later.
...
Previous phase: [SmartScreen API](./1-0-1724-prerelease.md#smartscreen-api) in _Prerelease SDK 1.0.1724-prerelease, for Runtime 113 (Mar. 20, 2023)_.
...
Previous phase: [Window Management permission type](./1-0-1724-prerelease.md#window-management-permission-type) in _Prerelease SDK 1.0.1724-prerelease, for Runtime 113 (Mar. 20, 2023)_.  That's phase 1.  Phase 2 is not in release notes.
