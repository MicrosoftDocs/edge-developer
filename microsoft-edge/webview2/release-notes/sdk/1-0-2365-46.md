...
Release notes for Microsoft Edge WebView2 SDK, release date: Feb. 26, 2024.

[NuGet package for WebView2 SDK 1.0.2365.46](https://www.nuget.org/packages/Microsoft.Web.WebView2/1.0.2365.46)

For full API compatibility, this Release version of the WebView2 SDK requires WebView2 [Runtime 122.0.2365.46 (Feb. 26, 2024)](../runtime/122.md) or later.
