...
Release notes for Microsoft Edge WebView2 SDK, release date: Feb. 15, 2023.

[NuGet package for WebView2 SDK 1.0.1587.40](https://www.nuget.org/packages/Microsoft.Web.WebView2/1.0.1587.40)

For full API compatibility, this Release version of the WebView2 SDK requires WebView2 [Runtime 110.0.1587.40 (Feb. 15, 2023)](../runtime/110.md) or later.
