---
title: Release SDK 1.0.902.49, for Runtime 92 (Jul. 26, 2021)
description: Release notes for Microsoft Edge WebView2, for Release SDK 1.0.902.49.
author: MSEdgeTeam
...
Release notes for Microsoft Edge WebView2 SDK, release date: Jul. 26, 2021.

[NuGet package for WebView2 SDK 1.0.902.49](https://www.nuget.org/packages/Microsoft.Web.WebView2/1.0.902.49)

For full API compatibility, this Release version of the WebView2 SDK requires WebView2 [Runtime 92.0.902.49 (Jul. 26, 2021)](../runtime/92.md) or later.
