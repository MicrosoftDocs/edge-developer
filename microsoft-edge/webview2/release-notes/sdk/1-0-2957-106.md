...
description: Release notes for Microsoft Edge WebView2, for Release SDK 1.0.2957.106.
author: MSEdgeTeam
...
Release notes for Microsoft Edge WebView2 SDK, release date: Jan. 20, 2025.

[NuGet package for WebView2 SDK 1.0.2957.106](https://www.nuget.org/packages/Microsoft.Web.WebView2/1.0.2957.106)

For full API compatibility, this Release version of the WebView2 SDK requires WebView2 [Runtime 132.0.2957.106 (Jan. 20, 2025)](../runtime/132.md) or later.
...
Previous phase: [Show WPF elements on top of the WebView2 layer (WebView2CompositionControl)](./1-0-3079-prerelease.md#show-wpf-elements-on-top-of-the-webview2-layer-webview2compositioncontrol) in _Prerelease SDK 1.0.3079-prerelease, for Runtime 134 (Jan. 24, 2025)_.
