---
title: Prerelease SDK 1.0.1619-prerelease, for Runtime 111 (Jan. 19, 2023)
description: Release notes for Microsoft Edge WebView2, for Prerelease SDK 1.0.1619-prerelease.
author: MSEdgeTeam
...
Release notes for Microsoft Edge WebView2 Prerelease SDK, release date: Jan. 19, 2023.
...
For full API compatibility, this Prerelease version of the WebView2 SDK requires the WebView2 Runtime that ships with Microsoft Edge version 111.0.1619.0 or later; see [Runtime 111.0.1661.34 (Mar. 20, 2023)](../runtime/111.md).
