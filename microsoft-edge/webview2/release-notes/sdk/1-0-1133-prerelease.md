---
title: Prerelease SDK 1.0.1133-prerelease, for Runtime 99 (Jan. 13, 2022)
description: Release notes for Microsoft Edge WebView2, for Prerelease SDK 1.0.1133-prerelease.
author: MSEdgeTeam
...
Release notes for Microsoft Edge WebView2 Prerelease SDK, release date: Jan. 13, 2022.
...
For full API compatibility, this Prerelease version of the WebView2 SDK requires the WebView2 Runtime that ships with Microsoft Edge version 99.0.1133.0 or later; see [Runtime 99.0.1150.38 (Mar. 10, 2022)](../runtime/99.md).
