---
title: Release SDK 0.9.538, for Runtime 85 (Jun. 8, 2020)
description: Release notes for Microsoft Edge WebView2, for Release SDK 0.9.538.
author: MSEdgeTeam
...
Release notes for Microsoft Edge WebView2 SDK, release date: Jun. 8, 2020.

[NuGet package for WebView2 SDK 0.9.538](https://www.nuget.org/packages/Microsoft.Web.WebView2/0.9.538)

This Release version of the WebView2 SDK requires Microsoft Edge version 85.0.538.0 or later; see [Runtime 85.9.538 (Jun. 8, 2020)](../runtime/85.md).


<!-- ------------------------------ -->
#### All platforms

* Dropping support for WebView2 [Release SDK 0.8.149, for Runtime 76 (May 6, 2019)](./0-8-149.md).  We recommend staying up to date with the latest version of WebView2.
