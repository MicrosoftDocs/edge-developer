...
Release notes for Microsoft Edge WebView2 SDK, release date: May 31, 2021.

[NuGet package for WebView2 SDK 1.0.864.35](https://www.nuget.org/packages/Microsoft.Web.WebView2/1.0.864.35)

For full API compatibility, this Release version of the WebView2 SDK requires WebView2 [Runtime 91.0.864.35 (May 31, 2021)](../runtime/91.md) or later.
...
* Improved the `NewWindowRequested` documentation. ([Issue #448](https://github.com/MicrosoftEdge/WebViewFeedback/issues/448)).
