---
title: Prerelease SDK 1.0.1988-prerelease, for Runtime 117 (Jul. 24, 2023)
description: Release notes for Microsoft Edge WebView2, for Prerelease SDK 1.0.1988-prerelease.
author: MSEdgeTeam
...
For full API compatibility, this Prerelease version of the WebView2 SDK requires the WebView2 Runtime that ships with Microsoft Edge version 117.0.1988.0 or later; see [Runtime 117.0.2045.28 (Sep. 18, 2023)](../runtime/117.md).
