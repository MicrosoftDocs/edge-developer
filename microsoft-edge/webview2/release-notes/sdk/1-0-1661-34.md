---
title: Release SDK 1.0.1661.34, for Runtime 111 (Mar. 20, 2023)
description: Release notes for Microsoft Edge WebView2, for Release SDK 1.0.1661.34.
author: MSEdgeTeam
...
Release notes for Microsoft Edge WebView2 SDK, release date: Mar. 20, 2023.

[NuGet package for WebView2 SDK 1.0.1661.34](https://www.nuget.org/packages/Microsoft.Web.WebView2/1.0.1661.34)

For full API compatibility, this Release version of the WebView2 SDK requires WebView2 [Runtime 111.0.1661.34 (Mar. 20, 2023)](../runtime/111.md) or later.
...
* [Promotions to Phase 3 (Stable in Release)](#promotions-to-phase-3-stable-in-release)
   ...
   * [Controller's script locale](#controllers-script-locale)
* [See also](#see-also)
...
Previous phase: [SharedBuffer API](./1-0-1671-prerelease.md#sharedbuffer-api) in _Prerelease SDK 1.0.1671-prerelease, for Runtime 112 (Feb. 15, 2023)_.
...
Previous phase: [Permission management API](./1-0-1619-prerelease.md#permission-management-api) in _Prerelease SDK 1.0.1619-prerelease, for Runtime 111 (Jan. 19, 2023)_.  That's phase 1.  Phase 2 isn't in release notes.
...
Previous phase: [Tracking Prevention API](./1-0-1619-prerelease.md#tracking-prevention-api) in _Prerelease SDK 1.0.1619-prerelease, for Runtime 111 (Jan. 19, 2023)_.
...
Previous phase: [ScriptLocale API](./1-0-1671-prerelease.md#scriptlocale-api) in _Prerelease SDK 1.0.1671-prerelease, for Runtime 112 (Feb. 15, 2023)_.
