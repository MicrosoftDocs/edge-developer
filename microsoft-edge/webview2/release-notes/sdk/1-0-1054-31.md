---
title: Release SDK 1.0.1054.31, for Runtime 96 (Nov. 29, 2021)
description: Release notes for Microsoft Edge WebView2, for Release SDK 1.0.1054.31.
author: MSEdgeTeam
...
Release notes for Microsoft Edge WebView2 SDK, release date: Nov. 29, 2021.

[NuGet package for WebView2 SDK 1.0.1054.31](https://www.nuget.org/packages/Microsoft.Web.WebView2/1.0.1054.31)

For full API compatibility, this Release version of the WebView2 SDK requires WebView2 [Runtime 96.0.1054.31 (Nov. 29, 2021)](../runtime/96.md) or later.
...
* [Runtime 96.0.1054.31 (Nov. 29, 2021)](../runtime/96.md)
