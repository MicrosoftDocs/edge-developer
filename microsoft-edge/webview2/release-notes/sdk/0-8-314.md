---
title: Release SDK 0.8.314, for Runtime 80 (Oct. 28, 2019)
description: Release notes for Microsoft Edge WebView2, for Release SDK 0.8.314.
author: MSEdgeTeam
...
[NuGet package for WebView2 SDK 0.8.314](https://www.nuget.org/packages/Microsoft.Web.WebView2/0.8.314) - This release has been unlisted at NuGet.

This Release version of the WebView2 SDK requires Microsoft Edge version 80.0.314.0 or later; see [Runtime 80.8.355 (Dec. 9, 2019)](../runtime/80.md).
...
* [Runtime 80.8.355 (Dec. 9, 2019)](../runtime/80.md)
