...
Release notes for Microsoft Edge WebView2 Prerelease SDK, release date: May 8, 2023.
...
For full API compatibility, this Prerelease version of the WebView2 SDK requires the WebView2 Runtime that ships with Microsoft Edge version 115.0.1829.0 or later; see [Runtime 115.0.1901.177 (Jul. 24, 2023)](../runtime/115.md).
