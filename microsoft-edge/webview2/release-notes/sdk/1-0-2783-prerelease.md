...
Release notes for Microsoft Edge WebView2 Prerelease SDK, release date: Aug. 26, 2024.
...
For full API compatibility, this Prerelease version of the WebView2 SDK requires the WebView2 Runtime that ships with Microsoft Edge version 129.0.2783.0 or later; see [Runtime 129.0.2792.45 (Sep. 23, 2024)](../runtime/129.md).
