---
title: Release SDK 1.0.1245.22, for Runtime 102 (Jun. 14, 2022)
description: Release notes for Microsoft Edge WebView2, for Release SDK 1.0.1245.22.
author: MSEdgeTeam
...
Release notes for Microsoft Edge WebView2 SDK, release date: Jun. 14, 2022.

[NuGet package for WebView2 SDK 1.0.1245.22](https://www.nuget.org/packages/Microsoft.Web.WebView2/1.0.1245.22)

For full API compatibility, this Release version of the WebView2 SDK requires WebView2 [Runtime 102.0.1245.22 (Jun. 14, 2022)](../runtime/102.md) or later.
...
* [Promotions to Phase 3 (Stable in Release)](#promotions-to-phase-3-stable-in-release)
   ...
   * [ClearBrowsingData API](#clearbrowsingdata-api)
   * [HttpStatusCode API](#httpstatuscode-api)
* [Bug fixes](#bug-fixes)
* [See also](#see-also)
...
The [Server Certificate API](/microsoft-edge/webview2/reference/win32/icorewebview2_14?view=webview2-1.0.1245.22&preserve-view=true) which provides an option to trust the server's TLS certificate at the application level.

It renders the page without prompting the user about TLS or providing the ability to cancel the web request.

Previous phase: [Server Certificate API](./1-0-1248-prerelease.md#server-certificate-api) in _Prerelease SDK 1.0.1248-prerelease, for Runtime 102 (May 9, 2022)_.
...
Previous phase: [ClearBrowsingData API](./1-0-1248-prerelease.md#clearbrowsingdata-api) in _Prerelease SDK 1.0.1248-prerelease, for Runtime 102 (May 9, 2022)_.
