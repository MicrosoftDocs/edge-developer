...
Release notes for Microsoft Edge WebView2 SDK, release date: Apr. 21, 2021.

[NuGet package for WebView2 SDK 1.0.818.41](https://www.nuget.org/packages/Microsoft.Web.WebView2/1.0.818.41)

For full API compatibility, this Release version of the WebView2 SDK requires WebView2 [Runtime 90.0.818.41 (Apr. 21, 2021)](../runtime/90.md) or later.
...
* [Runtime 90.0.818.41 (Apr. 21, 2021)](../runtime/90.md)
