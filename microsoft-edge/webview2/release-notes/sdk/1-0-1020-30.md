...
Release notes for Microsoft Edge WebView2 SDK, release date: Oct. 25, 2021.

[NuGet package for WebView2 SDK 1.0.1020.30](https://www.nuget.org/packages/Microsoft.Web.WebView2/1.0.1020.30)

For full API compatibility, this Release version of the WebView2 SDK requires WebView2 [Runtime 95.0.1020.30 (Oct. 25, 2021)](../runtime/95.md) or later.
