...
Release notes for Microsoft Edge WebView2 SDK, release date: Apr. 22, 2024.

[NuGet package for WebView2 SDK 1.0.2478.35](https://www.nuget.org/packages/Microsoft.Web.WebView2/1.0.2478.35)

For full API compatibility, this Release version of the WebView2 SDK requires WebView2 [Runtime 124.0.2478.35 (Apr. 22, 2024)](../runtime/124.md) or later.
