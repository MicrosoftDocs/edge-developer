...
Release notes for Microsoft Edge WebView2 Prerelease SDK, release date: Oct. 29, 2021.
...
For full API compatibility, this Prerelease version of the WebView2 SDK requires the WebView2 Runtime that ships with Microsoft Edge version 97.0.1056.0 or later; see [Runtime 97.0.1072.54 (Jan. 13, 2022)](../runtime/97.md).
