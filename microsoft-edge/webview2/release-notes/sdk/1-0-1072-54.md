...
Release notes for Microsoft Edge WebView2 SDK, release date: Jan. 13, 2022.

[NuGet package for WebView2 SDK 1.0.1072.54](https://www.nuget.org/packages/Microsoft.Web.WebView2/1.0.1072.54)

For full API compatibility, this Release version of the WebView2 SDK requires WebView2 [Runtime 97.0.1072.54 (Jan. 13, 2022)](../runtime/97.md) or later.
