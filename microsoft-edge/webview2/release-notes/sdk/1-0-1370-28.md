...
Release notes for Microsoft Edge WebView2 SDK, release date: Oct. 11, 2022.

[NuGet package for WebView2 SDK 1.0.1370.28](https://www.nuget.org/packages/Microsoft.Web.WebView2/1.0.1370.28)

For full API compatibility, this Release version of the WebView2 SDK requires WebView2 [Runtime 106.0.1370.28 (Oct. 11, 2022)](../runtime/106.md) or later.
