...
Release notes for Microsoft Edge WebView2 SDK, release date: Sep. 8, 2025.

[NuGet package for WebView2 SDK 1.0.3485.44](https://www.nuget.org/packages/Microsoft.Web.WebView2/1.0.3485.44)

For full API compatibility, this Release version of the WebView2 SDK requires WebView2 [Runtime 140.0.3485.44 (Sep. 8, 2025)](../runtime/140.md) or later.
