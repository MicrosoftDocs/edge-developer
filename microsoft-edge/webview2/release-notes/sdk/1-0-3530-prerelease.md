---
title: Prerelease SDK 1.0.3530-prerelease, for Runtime 141 (Sep. 8, 2025)
description: Release notes for Microsoft Edge WebView2, for Prerelease SDK 1.0.3530-prerelease.
author: MSEdgeTeam
...
Release notes for Microsoft Edge WebView2 Prerelease SDK, release date: Sep. 8, 2025.
...
For full API compatibility, this Prerelease version of the WebView2 SDK requires the WebView2 Runtime that ships with Microsoft Edge version 141.0.3530.0 or later; see [Runtime 141.0.3537.50 (Oct. 6, 2025)](../runtime/141.md).
