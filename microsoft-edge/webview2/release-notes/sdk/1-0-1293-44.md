...
Release notes for Microsoft Edge WebView2 SDK, release date: Aug. 8, 2022.

[NuGet package for WebView2 SDK 1.0.1293.44](https://www.nuget.org/packages/Microsoft.Web.WebView2/1.0.1293.44)

For full API compatibility, this Release version of the WebView2 SDK requires WebView2 [Runtime 104.0.1293.44 (Aug. 8, 2022)](../runtime/104.md) or later.
