...
* Added [WebView2 Group Policies](/deployedge/microsoft-edge-webview-policies).  For best practices for using group policies, see [Enterprise management of WebView2 Runtimes](../../concepts/enterprise.md).
