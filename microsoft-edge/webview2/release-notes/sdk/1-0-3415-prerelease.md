---
title: Prerelease SDK 1.0.3415-prerelease, for Runtime 140 (Jul. 14, 2025)
description: Release notes for Microsoft Edge WebView2, for Prerelease SDK 1.0.3415-prerelease.
author: MSEdgeTeam
...
For full API compatibility, this Prerelease version of the WebView2 SDK requires the WebView2 Runtime that ships with Microsoft Edge version 140.0.3415.0 or later; see [Runtime 140.0.3485.44 (Sep. 8, 2025)](../runtime/140.md).
...
Previous phase: [Customize the Find behavior (Find API)](./1-0-3079-prerelease.md#customize-the-find-behavior-find-api) in _Prerelease SDK 1.0.3079-prerelease, for Runtime 134 (Jan. 24, 2025)_.
