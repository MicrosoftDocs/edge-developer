...
description: New features, APIs, and fixes in WebView2 Release SDK 0.9.538.
author: MSEdgeTeam
...
*  Dropping support for WebView2 SDK Version [0.8.149](./0-8-149.md).  We recommend staying up-to-date with the latest version of WebView2.
