---
title: Release SDK 1.0.3719.77, for Runtime 144 - SDK (Jan. 27, 2026)
description: Release notes for Microsoft Edge WebView2, for Release SDK 1.0.3719.77 - SDK.
author: MSEdgeTeam
...
ms.date: 06/11/2026
---
# Release SDK 1.0.3719.77, for Runtime 144 - SDK (Jan. 27, 2026)
...
Previous phase: [Customize the drag and drop behavior (DragStarting API)](./1-0-3712-prerelease-sdk.md#customize-the-drag-and-drop-behavior-dragstarting-api) in _Prerelease SDK 1.0.3712-prerelease, for Runtime 144 - SDK (Dec. 8, 2025)_.
