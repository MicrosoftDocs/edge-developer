...
Previous phase: [Customize the drag and drop behavior (DragStarting API)](./1-0-3712-prerelease.md#customize-the-drag-and-drop-behavior-dragstarting-api) in _Prerelease SDK 1.0.3712-prerelease, for Runtime 144 (Dec. 8, 2025)_.
