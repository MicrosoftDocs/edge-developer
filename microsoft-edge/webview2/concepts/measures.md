...
* [Allowlist the WebView2 Runtime and app's host executables](#allowlist-the-webview2-runtime-and-apps-host-executables)
   * [Runtime initialization is blocked](#runtime-initialization-is-blocked)
      * [Symptoms](#symptoms)
      * [Solutions](#solutions)
* [Preserve default Access Control Lists (ACLs) on Runtime folders](#preserve-default-access-control-lists-acls-on-runtime-folders)
* [Preserve Low Integrity Level (LowIL) on Runtime folders](#preserve-low-integrity-level-lowil-on-runtime-folders)
* [Preserve default Access Control Lists (ACLs) on the app's user data folder (UDF)](#preserve-default-access-control-lists-acls-on-the-apps-user-data-folder-udf)
...
* [Allow Runtime folder access, child processes, and child process creation](#allow-runtime-folder-access-child-processes-and-child-process-creation)
...
* [Don't modify WebView2 Runtime files that Windows components load from C:\Windows\System32](#dont-modify-webview2-runtime-files-that-windows-components-load-from-cwindowssystem32)
...
See:
* [Enterprise management of WebView2](./enterprise.md)
...
* [Enterprise management of WebView2](./enterprise.md)<!-- toc bucket 7 node 3 -->
