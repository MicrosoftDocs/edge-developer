...
Microsoft Defender SmartScreen ("SmartScreen") is a security feature that is enabled by default to help users safely browse the web.  The `IsReputationCheckingRequired` property controls whether SmartScreen is enabled.  Generally, all other services in Microsoft Edge > **Settings and more** (![Settings and more icon](./data-privacy-images/settings-and-more-icon.png)) > **Settings** > **Privacy and security** (and in **Settings and more** (![Settings and more icon](./data-privacy-images/settings-and-more-icon.png)) > **Settings** > **Search and services**) are turned off, for WebView2.
