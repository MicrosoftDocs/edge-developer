...
The Fixed Version runtime distribution model is also called a "self-contained" distribution approach; the redistributable bits are included with your app.
