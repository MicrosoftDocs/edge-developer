...
| `edge-webview-interactive-dragging` | Enables pointer and focus events to occur on elements that have the `--app-region: drag` attribute.  Otherwise, drag elements are non-interactive. |
