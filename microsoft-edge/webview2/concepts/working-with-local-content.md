...
*  To allow references to other local files from file URIs or to display XML files with XSL transormations, you can set the `--allow-file-access-from-files` [browser argument](https://learn.microsoft.com/dotnet/api/microsoft.web.webview2.core.corewebview2environmentoptions.additionalbrowserarguments).
