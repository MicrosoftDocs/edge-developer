...
[ZoomFactorChanged](#zoomfactorchanged) | ZoomFactorChanged fires when the ZoomFactor property of the WebView changes.
...
> public void [SetBoundsAndZoomFactor](#setboundsandzoomfactor)(Rectangle Bounds, double ZoomFactor)
