...
*  Added support for Windows 7, Windows 8, and Windows 8.1.  However, see [Supported platforms](./index.md#supported-platforms) in _Introduction to Microsoft Edge WebView2_.
