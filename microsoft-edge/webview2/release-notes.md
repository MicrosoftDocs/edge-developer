...
todo: move these h2 sections to individual .md files, then remove this .md file and define redirects for each h2 anchor.  https://learn.microsoft.com/microsoft-edge/webview2/release-notes
