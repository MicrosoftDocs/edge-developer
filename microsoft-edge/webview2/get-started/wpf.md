...
*   The [WebView2 Runtime][Webview2Installer] or any [Microsoft Edge Insider (preview) Channel][MicrosoftedgeinsiderDownload] must be installed on a supported OS \(currently Windows 11, Windows 10, Windows 8.1, and Windows 7\).
