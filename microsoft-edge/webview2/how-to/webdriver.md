...
Because WebView2 is based on the Chromium engine, WebView2 app developers can take advantage of standard web tooling for debugging and automation, such as Selenium.  Selenium implements the W3C [WebDriver][W3cWebdriver2] API.  In a WebView2 app, you can use Selenium to create automated tests to simulate user interactions.
